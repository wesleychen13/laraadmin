                            ...
                            <div class="col-lg-10">
                                <form name="form_product" id="form-validation" action="" class="form-horizontal form-validation" accept-charset="UTF-8" method="post">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-form-label col-sm-3">所属角色</label>
                                        <div class="col-sm-9">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-form-label col-sm-3">账号</label>
                                        <div class="col-sm-9"><input id="txt_name" name="info[username]" class="form-control" value="{{ $data['username'] or ''}}" placeholder="账号"></div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-form-label col-sm-3">真实姓名</label>
                                        <div class="col-sm-9"><input id="txt_real_name" name="info[real_name]" class="form-control" value="{{ $data['real_name'] or ''}}" placeholder="真实姓名"></div>
                                    </div>
                                    <div class="form-group row">
