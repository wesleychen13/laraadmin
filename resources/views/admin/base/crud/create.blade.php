                        ...
                        <div class="col-lg-10">
                            <form name="form_product" id="form-validation" action="" class="form-horizontal form-validation" accept-charset="UTF-8" method="post">
        						 ...
        						 <div class="form-group row">
                                    <label class="col-form-label col-sm-3">选择表</label>
                                    <div class="col-sm-9">
                                ...
                                <div class="form-group row">
                               <label class="col-form-label col-sm-3">所属菜单</label>
                                    <div class="col-sm-9">
                               ...
                               <div class="form-group row">
                                 ...
                                 <div class="form-group row">
                                    <label class="col-form-label col-sm-3">Repository</label>
                                    <div class="col-sm-9">
	...
	<script type="text/javascript">
        ...
        $(function() {
			...
			$("#c_model").change(function() {
                $.getJSON('/admin/Base/Crud/checkModelPath?path=' + $(this).val(),function(data) {
                    $("#alert_model").html(data.msg);
                });
            });
            $("#c_repositories").change(function() {
                $.getJSON('/admin/Base/Crud/checkServicePath?path=' + $(this).val(),function(data) {
                    if(data.status != 200) {
            ...
            $("#c_control").change(function() {
                $.getJSON('/admin/Base/Crud/checkControllerPath?path=' + $(this).val(),function(data) {
                    if(data.status != 200) {
            ...
            $("#c_path").change(function() {
                $.getJSON('/admin/Base/Crud/checkPath?path=' + $(this).val(),function(data) {
                    if(data.status != 200) {
